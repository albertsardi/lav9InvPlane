...
<script>
    ...
    $(function () {
        ...
        //cmAddNew
        $(document).on('click', 'button#cmAddNew', function () {
            alert('cm add new');
        });
...
<div class="row">
    <div class="col-xs-12 col-md-4">
        <div class="btn-group">
            ...
            <button id="cmAddProduct" type="button" class="btn_add_product btn btn-sm btn-default"><i class="fa fa-database"></i>Add product</button>
        </div>
    </div>
